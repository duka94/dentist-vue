  ...
  <section class="contact-page">
    ...
    <div class="contact-page__info container">
      <div class="row">
          ...
          <div class="contact-page__information">
            ...
            <div class="number">
              <a href="tel: 065/444-44-44">
                <svg
                  class="svg-inline--fa fa-w-14 fa-rotate-90"
                  aria-hidden="true"
                  data-prefix="fab"
                  data-icon="phone"
                  role="img"
                ...
                >
                  <path
                    fill="currentColor"
                    d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48
                    112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2
            ...
            <div class="mail">
              <a href="mailto: info@oridinacija.com">
                ...
                >
                  <path
                  fill="currentColor"
                  d="M464 64H48C21.49 64 0 85.49 0 112v288c0 26.51 21.49 48
                  48 48h416c26.51 0 48-21.49 48-48V112c0-26.51-21.49-48-48-48zm0
            ...
            <div class="row">
              <div class="contact-page__info-social">
                <a href=" https://www.facebook.com/stomatoloska.ordinacija.sreckov/ " target="_blank">
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M76.7 512V283H0v-91h76.7v-71.7C76.7 42.4 124.3 0 193.8 0c33.3
                      0 61.9 2.5 70.2 3.6V85h-48.2c-37.8 0-45.1 18-45.1 44.3V192H256l-11.7
                      91h-73.6v229"
                    />
                  </svg>
                </a>
              ...
              <div class="contact-page__info-social">
                <a
                  href=" https://www.linkedin.com/in/ordinacija-sreckov-364673165/?trk=onboarding-landing&amp;dl=no"
                  target="_blank"
                >
                  <svg
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M100.3 448H7.4V148.9h92.9V448zM53.8
                       108.1C24.1 108.1 0 83.5 0 53.8S24.1 0
                        53.8 0s53.8 24.1 53.8 53.8-24.1
                        54.3-53.8 54.3zM448 448h-92.7V302.4c0-34.7-.7-79.2
                        -48.3-79.2-48.3 0-55.7 37.7-55.7
                        76.7V448h-92.8V148.9h89.1v40.8h1.3c12.4-23.5 42.7-48.3 87.9-48.3 94 0
                        111.3 61.9 111.3 142.3V448h-.1z"
                    />
                  </svg>
                </a>
              </div>
        ...
        <div class="col-lg-7">
          <gmapMap
            :center="{lat:45.25506358760583, lng:19.81867544801094}"
            :zoom="16"
            map-type-id="terrain"
            ...
            >
              <path
                ...
                d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941
                 ...
                 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373
